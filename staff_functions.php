...
function resizeImage($sourcePath, $maxWidth = 230, $maxHeight = 230) {
    ...
    list($width, $height, $imageType) = getimagesize($fullPath);
    ...
    if (!$new_image) {
        throw new RuntimeException('Failed to create a new image');
    }
    ...
    if (!$source) {
        throw new RuntimeException('Failed to create the source image');
    }
